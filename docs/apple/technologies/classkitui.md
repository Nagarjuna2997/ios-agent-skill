...
Load this when a task names **ClassKit UI** or one of the API topics below.

Apple categories: App Services.

[Apple documentation](https://developer.apple.com/documentation/classkitui) · Source checked: 2026-09-16.
...
Documented modules: `ClassKit UI`.

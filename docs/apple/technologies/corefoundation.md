...
Load this when a task names **Core Foundation** or one of the API topics below.

Apple categories: App Frameworks.

[Apple documentation](https://developer.apple.com/documentation/corefoundation) · Source checked: 2026-09-16.
...
Documented modules: `Core Foundation`.
...
- [CFURLEnumerator](https://developer.apple.com/documentation/corefoundation/cfurlenumerator)

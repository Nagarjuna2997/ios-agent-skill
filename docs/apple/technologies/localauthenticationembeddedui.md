...
Load this when a task names **Local Authentication Embedded UI** or one of the API topics below.

Apple categories: System.

[Apple documentation](https://developer.apple.com/documentation/localauthenticationembeddedui) · Source checked: 2026-09-16.
...
Documented modules: `Local Authentication Embedded UI`.

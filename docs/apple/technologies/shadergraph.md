...
Load this when a task names **ShaderGraph** or one of the API topics below.

Apple categories: Developer Tools.

[Apple documentation](https://developer.apple.com/documentation/shadergraph) · Source checked: 2026-09-16.
...
Documented modules: `ShaderGraph`.

...
Load this when a task names **Visual Intelligence** or one of the API topics below.

Apple categories: App Frameworks.

[Apple documentation](https://developer.apple.com/documentation/visualintelligence) · Source checked: 2026-09-16.
...
Documented modules: `Visual Intelligence`.

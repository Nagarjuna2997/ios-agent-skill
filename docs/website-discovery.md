...
### Navigation and responsive UI requirements

Every main navbar must include the same visible, labelled light/dark control. Keep the brand and appearance control together, with destinations in a separate wrapping row when space is limited. Article back links must sit in their own spaced row below the main navigation, never flush against it. Use consistent destination labels and distinguish global navigation, article navigation, category filters and series progression. Verify arbitrary window widths, both appearances, keyboard focus and readable control contrast before publishing UI changes. Maintain these rules for future pages through shared templates and styles.

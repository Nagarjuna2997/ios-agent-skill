...
This tool result is not confirmation of a public report. Never upload source, paths, raw logs or exception text. Automatic category reporting needs prior opt-in and a configured service; detailed public reproduction steps require a separately reviewed, authorized report.`;
